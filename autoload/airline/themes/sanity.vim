...
let g:airline#themes#sanity#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3, s:file)
let g:airline#themes#sanity#palette.normal_modified = {
...
let g:airline#themes#sanity#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3, s:file)
let g:airline#themes#sanity#palette.insert_modified = copy(g:airline#themes#sanity#palette.normal_modified)
let g:airline#themes#sanity#palette.insert_paste = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_orange, ''],
      \ }

" Replace mode
let g:airline#themes#sanity#palette.replace = {
      ...
      \ }
let g:airline#themes#sanity#palette.replace_modified = copy(g:airline#themes#sanity#palette.insert_modified)
...
let g:airline#themes#sanity#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3, s:file)
let g:airline#themes#sanity#palette.visual_modified = copy(g:airline#themes#sanity#palette.insert_modified)

" Inactive window
let s:IA = [s:gui_dark_gray, s:gui_med_gray_hi, s:cterm_dark_gray, s:cterm_med_gray_hi, '']
let g:airline#themes#sanity#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA, s:file)
let g:airline#themes#sanity#palette.inactive_modified = {
